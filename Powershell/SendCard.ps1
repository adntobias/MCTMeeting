...
# "Double"-Encode everything with a "/"-character in it 
$replacments = @{
    "XY_INCI"= [System.Web.HttpUtility]::UrlEncode("") #looks like /subscriptions/8140799d-d299-4b7a-a726-57dd828bb63d/resourceGroups/sentinel/providers/Microsoft.OperationalInsights/workspaces/sentinelworkspace/providers/Microsoft.SecurityInsights/Incidents/a434bd5a-1694-4933-a485-e84c0237c7eb
    "XY_LINK"= [System.Web.HttpUtility]::UrlEncode("https://google.de")
...
foreach ($repl in $replacments.Keys) {
    $encoded =  [System.Web.HttpUtility]::UrlEncode($replacments[$repl])
